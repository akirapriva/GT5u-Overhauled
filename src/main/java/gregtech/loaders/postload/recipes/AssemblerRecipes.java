...
public class AssemblerRecipes implements Runnable {
    ...
    public void run() {
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(new ItemStack(Items.lead, 1, 32767))
            .itemOutputs(new ItemStack(Items.name_tag, 1, 0))
            .fluidInputs(Materials.Glue.getFluid(72))
            .duration(5 * SECONDS)
            .eut(8)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTOreDictUnificator.get(OrePrefixes.plate, Materials.Paper, 3))
            .itemOutputs(new ItemStack(Items.book, 1, 0))
            .fluidInputs(Materials.Glue.getFluid(20))
            .duration(1 * SECONDS + 12 * TICKS)
            .eut(8)
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(ItemList.Paper_Printed_Pages.get(1))
            .itemOutputs(new ItemStack(Items.written_book, 1, 0))
            .fluidInputs(Materials.Glue.getFluid(20))
            .duration(1 * SECONDS + 12 * TICKS)
            .eut(8)
    ...
    public void loadInputBusesRecipes() {
        ...
        {
            GTValues.RA.stdBuilder()
                .itemInputs(ItemList.Hull_ULV.get(1), GTUtility.getIntegratedCircuit(1))
    ...
    public void loadOutputBusesRecipes() {
        ...
        {
            GTValues.RA.stdBuilder()
                .itemInputs(ItemList.Hull_ULV.get(1), GTUtility.getIntegratedCircuit(2))
    ...
    // Pipe Casings
    {
        ...
        // Item Pipe
        {
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    GTOreDictUnificator.get(OrePrefixes.pipeMedium, Materials.Tin, 4), // issue
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    GTOreDictUnificator.get(OrePrefixes.pipeMedium, Materials.Quantium, 4), // issue
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    GTOreDictUnificator.get(OrePrefixes.pipeMedium, Materials.ElectrumFlux, 4), // issue
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    GTOreDictUnificator.get(OrePrefixes.pipeMedium, Materials.BlackPlutonium, 4), // issue
                    GTOreDictUnificator.get(OrePrefixes.plate, Materials.BlackPlutonium, 4),
                    GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.BlackPlutonium, 1),
                    GTUtility.getIntegratedCircuit(12))
    ...
    public void withGalaxySpace() {
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                GTOreDictUnificator.get(OrePrefixes.wireGt01, Materials.Longasssuperconductornameforuhvwire, 24),
                // GTOreDictUnificator.get(OrePrefixes.pipeMedium, Materials.Bedrockium, 1),
                ItemList.Electric_Pump_UHV.get(1),
                GTUtility.getIntegratedCircuit(9))
            .itemOutputs(GTOreDictUnificator.get(OrePrefixes.wireGt01, Materials.SuperconductorUHV, 24))
    ...
    public void withIC2NuclearControl() {
        ...
        if (TinkerConstruct.isModLoaded() && Railcraft.isModLoaded()) {
            GTValues.RA.stdBuilder()
                .itemInputs(
                    GTOreDictUnificator.get(OrePrefixes.plate, Materials.Neutronium, 2),
