...
public class LoaderMetaTileEntities implements Runnable { // TODO CHECK CIRCUIT RECIPES AND USAGES
    ...
    private static void generateWiresAndPipes() {
        ...
        generateItemPipes(Materials.Tin, Materials.Tin.mName, 5589, 2);
        generateItemPipes(Materials.Brass, Materials.Brass.mName, 5602, 4);
        generateItemPipes(Materials.Electrum, Materials.Electrum.mName, 5612, 8);
        generateItemPipes(Materials.Platinum, Materials.Platinum.mName, 5622, 16);
        generateItemPipes(Materials.Osmium, Materials.Osmium.mName, 5632, 32);
        generateItemPipes(Materials.ElectrumFlux, Materials.ElectrumFlux.mName, 5650, 64);
        generateItemPipes(Materials.BlackPlutonium, Materials.BlackPlutonium.mName, 5660, 128);
        generateItemPipes(Materials.Bedrockium, Materials.Bedrockium.mName, 5670, 256);
        ...
        generateItemPipes(Materials.Quantium, Materials.Quantium.mName, 5730, 512);
